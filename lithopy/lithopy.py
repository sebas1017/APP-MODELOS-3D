...
from search_service import main_process
import easygui
...
def main():
	query = easygui.enterbox("Que imagen deseas???Ingresa una palabra clave o texto")
	name_of_file = main_process(query)
	rawImg = cv.imread("images/"+name_of_file+" 1920x10800.jpg", flags=cv.IMREAD_COLOR)
